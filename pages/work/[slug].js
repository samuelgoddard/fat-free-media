        ...
        >
          <motion.div variants={fade} className=" overflow-hidden relative">
            ...
            <div className="relative">
              ...
              <div data-scroll data-scroll-speed="1.3" className="border-t border-b border-off-black pt-3 pb-4 mb-5 md:mb-0">
                  ...
                  <div className="relative">
                    <div className="w-full bg-green relative z-10">
                      <button className="text-yellow absolute top-0 left-0 mt-8 ml-8 md:ml-16 md:mt-16 xl:ml-24 xl:mt-24 z-20">
                        <span className="absolute top-0 left-0 right-0 bottom-0 text-off-black flex flex-wrap items-center justify-center leading-none tracking-tight text-base xl:text-xl px-5">Watch in full</span>
              ...
              <div className="relative overflow-hidden pt-24 xl:pt-32 xl:-mt-16">
                <BigX color="text-white" bottom />
                <Container thin>
                  <div className="flex flex-wrap mb-12 md:mb-20 xl:mb-32 relative z-10" data-scroll data-scroll-speed="1.25">
                    ...
                    <div className="w-full md:w-7/12 content text-lg md:text-xl xl:text-2xl leading-snug tracking-tighter">
