      ...
      <Layout>
        ...
        >
          ...
          <motion.div variants={fade} className="mb-20 md:mb-20 overflow-hidden relative">
            ...
            <div className="relative z-20 bg-off-white pt-16 md:pt-24 xl:pt-32">
              <Container thin>
                <div className="w-full mb-0 md:mb-20 xl:mb-32 relative z-20">
                  <div className="flex flex-wrap">
                    <div className="w-11/12 md:w-full max-w-sm">
                      <div className="overflow-hidden relative">
                        <motion.span variants={reveal} className="block text-xs uppercase mb-1 md:mb-3 tracking-tighter leading-none">Information —</motion.span>
                      </div>
                ...
                {/* <div className="w-full mb-12 md:mb-16 xl:mb-24 relative z-10" data-scroll data-scroll-speed="1">
                  <div className="flex flex-wrap">
                    ...
                    <div className="w-full md:w-5/12 xl:w-6/12 md:ml-auto xl:mx-auto max-w-xl mt-3">
                      <p className="text-xl lg:text-2xl leading-snug tracking-tight mb-4 md:mb-6">We believe that every moment with a viewer is a privilege, and brands deserve creative bravery without the ego. That’s why you won’t find clickbait or talking heads in our portfolio.</p>
                ...
                <div className="w-full pb-16 md:pb-24 xl:pb-32 relative z-10">
                  <div className="flex flex-wrap">
                        ...
                        <div className="flex flex-col w-full md:w-1/3" key={i}>
                          <div className={`h-full border-b md:border-b-0 md:border-l border-dotted border-off-black border-opacity-50 md:px-8 lg:px-12 xl:px-16 ${spacing}`}>
                            <div data-scroll data-scroll-speed={scrollSpeed}>
                              <div className="relative mr-5 mb-5 w-11/12 md:w-full">
                                <Image
                                  data={{
                                    ...team.image.responsiveImage,
                                    alt: team.image.alt ? team.image.alt : team.image.title,
                                  }}
                                  className="w-full relative z-0 mb-8"
                                />
                              ...
                              <div className="relative overflow-hidden mb-5 md:mb-6 mt-3">
                              ...
                              <div dangerouslySetInnerHTML={{ __html: team.shortBio }} className="font-mono text-sm mb-3 md:mb-5 w-11/12 md:w-full"></div>
            ...
            <div className="pb-20 md:pb-24 xl:pb-32 -mt-1 -mb-1 2xl:pb-40 relative z-20 bg-off-white">
              <Container>
            ...
            <div className="pb-20 md:pb-24 xl:pb-32 2xl:pb-40 relative z-20 bg-off-white">
              <Container thin>
                ...
                {services.map((service, i) => {
                  ...
                  return(
                    <div key={i} className={`py-10 md:py-12 md:my-3 border-dotted border-off-black border-opacity-50 ${paddingClass} ${ i !== 2 ? 'border-b' : 'md:border-b' }`}>
                      <div className="flex flex-wrap -mx-2 md:mx-0 md:items-center">
                        <div className="w-auto md:pr-12" style={ colour }>
                          <CircleInfinity />
                        </div>
                        <div className="flex-1 flex flex-wrap px-2 md:px-0 md:items-center">
                          <div className="w-full md:w-auto md:pr-12 xl:pr-24">
                            <h3 className="text-3xl md:text-3xl xl:text-4xl leading-none tracking-tighter md:w-40 xl:w-48">{ service.title }</h3>
                          </div>
                          <div className="flex-1 md:w-full relative z-10 pr-5">
                            <div className="font-mono text-sm lg:text-base mb-2 md:max-w-xl" dangerouslySetInnerHTML={{ __html: service.heroText }}></div>
            ...
            <div className="bg-yellow yellow-highlight pt-8 pb-20 md:pt-12 md:pb-20 lg:pt-16 lg:pb-24 xl:pt-20 xl:pb-32 overflow-hidden relative z-20">
            ...
            <div className="bg-off-white pt-6 md:pt-8 pb-8 md:pb-10 block text-center text-off-black text-4xl md:text-5xl xl:text-6xl tracking-tighter leading-none relative z-20">
