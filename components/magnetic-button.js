        ...
        <button id="magnetic-wrap" className="block relative justify-center items-center border-none focus:border-none hover:border-none outline-none focus:outline-none hover:outline-none" onClick={this.props.function}>
          ...
          <div className="magnetic-content">
            <span className="text-yellow block rounded-full relative shadow-xl">
              <span className="absolute top-0 left-0 right-0 bottom-0 text-off-black flex flex-wrap items-center justify-center leading-none tracking-tight text-lg xl:text-2xl px-5 2xl:px-8">{ this.props.text ? this.props.text : "WATCH" }</span>
