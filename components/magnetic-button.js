...
class MagneticButton extends Component {
  ...
  componentDidMount(){
    ...
    this.magneticArea.addEventListener('mousemove', function(e){
      callParallax(e);
    });
    
    this.magneticArea.addEventListener('mouseleave', function(e){
