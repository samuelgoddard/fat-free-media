      ...
      <Container>
        <div className="flex flex-wrap items-center pt-8">
          ...
          <div className="w-auto ml-auto">
            ...
            >
              <div className="relative overflow-hidden mx-2 md:mx-4 hidden md:inline-block text-lg">
                <motion.div variants={reveal}>
              ...
              <div className="relative overflow-hidden mx-2 md:mx-4 mr-0 xl:mr-0">
                <motion.div variants={scaleDown}>
                  <Link href={ activeMenu ? "/" : "/menu"}><a aria-label={ activeMenu ? "Navigate to home page" : "Navigate to menu" } className={`inline-block w-10 md:w-16 relative group transition ease-in-our duration-300 burger-wrap ${ theme === 'white' ? 'hover:text-white focus:text-white' : 'hover:text-orange focus:text-orange' }`}>
                    { !activeMenu ? (
                      <div className={`burger absolute top-0 left-0 z-10 mt-3 md:mt-5 ml-3 md:ml-4 ${ theme === 'white' ? 'text-orange' : 'text-off-white' }`}>
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
