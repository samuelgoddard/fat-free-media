...
import { xRoll } from "../helpers/transitionHelper"

export default function BigX({color, left, bottom}) {
  let bottomTheme = ``;
  let leftTheme = ``;

  if (bottom) {
    bottomTheme = `bg-x--bottom`
  }
  if (left) {
    leftTheme = `bg-x--left`
  }
